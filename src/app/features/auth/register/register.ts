    ...
    <div class="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-sm text-gray-500 mt-1">Start your journey today</p>
        </div>
          ...
          <form [formGroup]="form" (ngSubmit)="submit()" novalidate>
            ...
            <div class="mb-5">
              ...
              @if (showError('name', 'required')) {
                <p class="mt-1.5 text-xs text-red-500">Name is required</p>
              } @else if (showError('name', 'minlength')) {
                <p class="mt-1.5 text-xs text-red-500">Name must be at least 2 characters</p>
              }
            </div>
                  ...
                  <div class="flex gap-1 mb-1">
                    @for (segment of [0,1,2,3]; track segment) {
                      <div class="h-1 flex-1 rounded-full transition-colors duration-300"
                        [ngClass]="segment < passwordStrength ? strengthColors[passwordStrength - 1] : 'bg-gray-200'">
                      </div>
                    }
                  </div>
                  <p class="text-xs" [ngClass]="strengthTextColors[passwordStrength - 1] || 'text-gray-400'">
            ...
            <div class="mb-6">
              ...
              <div class="relative">
                ...
                <input
                  ...
                  autocomplete="new-password"
                  [ngClass]="fieldClass('confirmPassword')"
                  class="block w-full rounded-xl border pl-10 pr-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-0 transition"
                />
              </div>
              @if (showError('confirmPassword', 'required')) {
                <p class="mt-1.5 text-xs text-red-500">Please confirm your password</p>
              } @else if (form.errors?.['passwordMismatch'] && form.get('confirmPassword')!.touched) {
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
          ...
          <a routerLink="/login" class="font-semibold text-indigo-600 hover:text-indigo-500 transition">Sign in</a>
        </p>
